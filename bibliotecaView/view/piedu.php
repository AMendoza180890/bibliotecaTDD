<div class="container-fluid">
                        <div class="page-header">
                          <h2 class="all-tittles">Recurso Plan Individualizado de Educacion PIE</h2>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="text-center all-tittles">Todos los recursos para el area Individualizado de Educacion PIE</h3>
