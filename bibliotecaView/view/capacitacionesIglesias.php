<div class="container-fluid">
                        <div class="page-header">
                          <h2 class="all-tittles">Recursos de Capacitaciones para Iglesias</h2>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="text-center all-tittles">Todos los recursos de Capacitaciones para Iglesias</h3>
