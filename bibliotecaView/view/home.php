...
<section class="full-reset text-center" style="padding: 40px 0;">
    ...
    <a href="apoyoFamiliar">
        <article class="tile">
            <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
            <div class="tile-name all-tittles">Apoyo Familiar</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    <a href="conducta">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Conducta</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    <a href="curriculum">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">curriculo Tesoros de Dios</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    ...
    <a href="estimulacion">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Estimulación Temprana</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
</section>
<section class="full-reset text-center" style="padding: 40px 0;">
    <a href="fisioterapia">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Fisioterapia</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    <a href="historia">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Historias Sociales</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    <a href="iglesias">
    ...
    <a href="lenguaje">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Logopedia</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
    <a href="piedu">
        <article class="tile">
            <div class="tile-icon full-reset"><i class="zmdi zmdi-archive"></i></div>
            <div class="tile-name all-tittles">Plan Individualizado</div>
            <div class="tile-num full-reset"></div>
        </article>
    </a>
</section>
<section class="full-reset text-center" style="padding: 40px 0;">
    ...
    <a href="habilidad">
        <article class="tile">
            <div class="tile-icon full-reset"><i class="zmdi zmdi-run"></i></div>
            <div class="tile-name all-tittles">Vocacional</div>
            <div class="tile-num full-reset">&nbsp;</div>
        </article>
    </a>
    <a href="ingles">
        <article class="tile">
            ...
            <div class="tile-name all-tittles">Resources In English</div>
            <div class="tile-num full-reset">&nbsp;</div>
        </article>
    </a>
</section>